...
$elements = array(
	...
	'dimensions'=>array(
		'note'=>'These parameters goes into  $setting[\'dimensions\'] array',
		array(
			'width',
			'<i>integer</i>',
			'300',
	...
	'string'=>array(
		'note'=>'These parameters goes into  $setting[\'string\'] array',
		array(
			'lenght',
			'<i>integer</i>',
			'5',
	...
	'operations'=>array(
		'note'=>'These parameters goes into $setting[\'operations\'] array<br /><br />
		...
		<br />
		<br />
		<b>NOTE</b>: All operatione are applied in the exact order in which are inserted in this array. An exception is "logo", in fact is the last operation.
		<br />
		<br />
		To apply the same operation more than one time use _ symbol after the operation name and a unique sequence (within that operation). See `wave` example.
		<br />
		<br />
		First we get a look at some noises',
		array(
			'dots',
		...
		'_break1'=>'Now let`s look at text',
	...
	'colors'=>array(
		'note'=>'<p>
			These parameters goes into  $setting[\'colors\'] array<br /><br />
		...
		array(
			...
			'<i>string</i>',
			'"#ffffff"',
			'Color for background. For background You can even use "noise" and "cnoise" producing respectively a random grayscale noise and rgb noise'
		),
		array(
			'lines',
			'<i>string</i>',
	...
	'nums'=>array(
		'note'=>'These parameters goes into  $setting[\'nums\'] array',
		array(
			'lines',
			'<i>integer</i>',
			'50',
